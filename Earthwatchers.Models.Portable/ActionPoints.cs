    ...
    public static class ActionPoints
    {
        ...
        public static int Points(Action action)
        {
            ...
            switch (action)
            {
                ...
                case Action.PlayingRegionChanged: points = 0; break;  //Cuando cambias de pais de juego
                case Action.ContestWinnerAnnounced: points = 0; break;
                case Action.LandReseted: points = 0; break;  // ????
                case Action.ContextTutorialCompleted: points = 0; break;
                case Action.Log: points = 0; break;
                case Action.AutomaticShare: points = 0; break;
                case Action.CheckAchivements: points = 0; break;
                case Action.Top10: points = 0; break;
                case Action.Top1: points = 0; break;
                case Action.RegionCompleted: points = 0; break;
            }
