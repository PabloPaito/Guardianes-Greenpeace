...
namespace Earthwatchers.Services
{
    public class Global : System.Web.HttpApplication
    {
        ...
        void Application_Start(object sender, EventArgs e)
        {
            ...
            RouteTable.Routes.MapServiceRoute<CountryResource>("api/country");
            RouteTable.Routes.MapServiceRoute<RegionResource>("api/region");
            RouteTable.Routes.MapServiceRoute<CustomShareTextResource>("api/customsharetext");
        ...
        private IKernel GetKernel()
        {
            ...
            kernel.Bind<ICountryRepository>().To<CountryRepository>().WithConstructorArgument("connectionString", connectionstring);
            kernel.Bind<IRegionRepository>().To<RegionRepository>().WithConstructorArgument("connectionString", connectionstring);
            kernel.Bind<ICustomShareTextRepository>().To<CustomShareTextRepository>().WithConstructorArgument("connectionString", connectionstring);
