...
namespace Earthwatchers.Services.Resources
{
    ...
    public class LayersResource
    {
        ...
        public HttpResponseMessage<Layer> GetLayerByName(Earthwatchers.Models.KmlModels.Zone zon, HttpRequestMessage<Earthwatchers.Models.KmlModels.Zone> request)
        {
            Layer lay = layersRepository.GetLayerByName(zon.Name, zon.Show);
            if (lay == null)
            {
                return new HttpResponseMessage<Layer>(HttpStatusCode.NotFound);
            }
