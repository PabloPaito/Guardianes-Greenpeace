...
--Lands_Get 0, 0, 0, '','', 'POLYGON EMPTY', 0
--Lands_Get 17570
--Lands_Get 0, 1, 2
--Lands_Get 0, 1, 2, '', '', 'POLYGON EMPTY', 0, 'BO'
...
--Lands_Get 0, 0, 0, '','', 'POLYGON EMPTY', 4
...
BEGIN
	...
	where 
		...
		AND (@playingRegion = 0 OR l.RegionId = @playingRegion)
